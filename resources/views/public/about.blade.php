...
<main class="flex-grow w-full max-w-[1440px] mx-auto px-6 lg:px-12 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-gutter lg:gap-12">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 flex flex-col gap-4">
                <div class="flex items-center gap-3 border-b border-surface-variant pb-3">
                    <span class="material-symbols-outlined text-primary-container" style="font-variation-settings: 'FILL' 1;">monitoring</span>
                    <h3 class="font-h3 text-h3 text-on-background">24/7 Monitoring</h3>
                </div>
            ...
            <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 flex flex-col gap-4">
                <div class="flex items-center gap-3 border-b border-surface-variant pb-3">
                    <span class="material-symbols-outlined text-primary-container" style="font-variation-settings: 'FILL' 1;">warning</span>
                    <h3 class="font-h3 text-h3 text-on-background">Incident Handling</h3>
                </div>
                <p class="font-body-md text-body-md text-on-surface-variant">
            ...
            <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 flex flex-col gap-4">
                <div class="flex items-center gap-3 border-b border-surface-variant pb-3">
                    <span class="material-symbols-outlined text-primary-container" style="font-variation-settings: 'FILL' 1;">assignment</span>
                    <h3 class="font-h3 text-h3 text-on-background">SLA Management</h3>
                </div>
                <p class="font-body-md text-body-md text-on-surface-variant">
        ...
        <div class="flex flex-col gap-6">
            <!-- Large Image Card -->
            <div class="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden relative h-[400px] lg:h-[500px]">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/20 to-transparent flex flex-col justify-end p-6">
                    <div class="bg-surface-container-lowest/95 backdrop-blur border border-outline-variant rounded-lg p-4 max-w-sm">
                        <div class="flex justify-between items-center mb-2">
                            <span class="font-label-md text-label-md text-on-surface">Global Node Status</span>
                            <div class="flex items-center gap-1 bg-green-500/10 px-2 py-1 rounded-full">
                                <span class="w-1.5 h-1.5 rounded-full bg-green-600"></span>
                                <span class="font-label-sm text-label-sm text-green-700">OPTIMAL</span>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                <div class="font-label-sm text-label-sm text-outline uppercase mb-1">Active Routes</div>
                                <div class="font-code text-code text-primary font-medium">84,291</div>
                            </div>
                            <div>
                                <div class="font-label-sm text-label-sm text-outline uppercase mb-1">Current Load</div>
                                <div class="font-code text-code text-primary font-medium">32.4 Tbps</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center justify-between">
                    <span class="font-label-md text-label-md text-on-surface-variant">Core Uptime (YTD)</span>
                    <span class="font-h3 text-h3 text-primary-container">99.999%</span>
                </div>
                <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center justify-between">
                    <span class="font-label-md text-label-md text-on-surface-variant">Avg MTTR</span>
                    <span class="font-h3 text-h3 text-primary-container">&lt; 15m</span>
                </div>
            </div>
        </div>
    </div>
